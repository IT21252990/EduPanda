          ...
          <div className="flex-1 justify-center items-center mt-10 p-8">
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg mx-auto">
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <div className="flex items-center  dark:bg-gray-800 p-5 border-t-2 dark:border-gray-700 ">
                  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <div className="block ml-36 mr-96 my-auto text-xl font-bold text-gray-900 md:p-0 dark:text-white ">
                      Instructors
                    </div>
                    <button
                      type="button"
                ...
                <div className="flex items-center  dark:bg-gray-800 p-5  border-t-2  border-b-2 dark:border-gray-700 ">
                  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <div className="block ml-36 mr-96 my-auto text-xl font-bold text-gray-900 md:p-0 dark:text-white ">
                      Learners
                    </div>
